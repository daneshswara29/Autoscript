...
wget -N --no-check-certificate https://github.com/daneshswara29/BBRplus/releases/download/5.15.96-bbrplus/Debian-Ubuntu_Optional_linux-headers-5.15.96-bbrplus_5.15.96-bbrplus-1_amd64.deb>/dev/null 2>&1
wget -N --no-check-certificate https://github.com/daneshswara29/BBRplus/releases/download/5.15.96-bbrplus/Debian-Ubuntu_Required_linux-image-5.15.96-bbrplus_5.15.96-bbrplus-1_amd64.deb >/dev/null 2>&1
