...
export sem=$( curl -s https://raw.githubusercontent.com/daneshswara29/Autoscript/main/test/versions)
...
#22) clear ; wget https://raw.githubusercontent.com/daneshswara29/Autoscript/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
#25) clear ; del-xrays ;;
#30) clear ; user-xrays ;;
0) clear ; menu ;;
x) exit ;;
