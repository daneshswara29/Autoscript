...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/daneshswara29/Autoscript/main/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/daneshswara29/Autoscript/main/vps.conf"
